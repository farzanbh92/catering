...
const toggleDrawer=()=>{
  setIsDrawerOpen(!isDrawerOpen);
    ...
    return (
        ...
        <div className='text-2xl md:text-5xl font-medium self-center px-12 '>
         Master Chef
        </div>

        <div className='hidden md:flex self-center px-24'>
        ...
        <div className='md:flex self-center space-x-8 pl-4'>
         <div className='hidden md:flex'>
            <Button color={'green'} btnName={'Login'}/>
         </div>
         ...
         md:hidden fixed top-0 right-0 h-full w-0.3 bg-gray-200 text-black text-base font-medium transform transition-transform ease-in-out duration-1000 z-10`}>
                <ul className="space-y-8 pt-8">
                  ...
                  <li className='text-center hover:text-orange-300'>
                  <Button btnName={'Login'} color={'green'}/>
                  </li>
